...
local fileName = function(arg) return ("/sys/class/thermal/thermal_zone%s/temp"):format(arg) end
local files = {
    read_file(fileName("1")),
    read_file(fileName("2")),
    read_file(fileName("3")),
    read_file(fileName("4")),
...
local tempwidget = wibox.widget.textbox(math.ceil(max / 1000) .. "°C ")
...
clientkeys = gears.table.join(
    ...
    awful.key({ }, "XF86AudioMute",
        function () awful.util.spawn("amixer -D pulse set Master 1+ toggle") end)
)
